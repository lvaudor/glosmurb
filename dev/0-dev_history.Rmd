...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Collect OpenStreetMap data iteratively",
    Description = "Collect and format OpenStreetMap data in order to study urbanized floodplains -key-value-site-.",
    `Authors@R` = c(
...
usethis::use_mit_license("Lise Vaudor")
```
