...
#' @param pause the number of seconds to pause (useful when querying in batches). Defaults to 0.
#' @export
#'
#' @examples
get_osmdata=function(key, value, shape_name,return=TRUE, save=FALSE, dir_name="data/osmdata", pause=0){
